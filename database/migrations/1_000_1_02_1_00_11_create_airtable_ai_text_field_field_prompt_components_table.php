...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('airtable_ai_text_field_field_prompt_components', function (Blueprint $table) {
            $table->id();
            $table->foreignId('prompt_component_id')->nullable()->constrained(table: 'airtable_ai_text_field_prompt_components', indexName: 'airtable_ai_text_field_field_components_ai_text_field_id_foreign')->cascadeOnDelete();
